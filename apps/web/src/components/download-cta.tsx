  ...
  return (
    <section id="download" className="px-4 flex justify-center">
      <motion.div
        ...
        className="w-full max-w-5xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 py-2"
      >
        <div>
        ...
        <div className="flex items-center gap-3 flex-shrink-0">
          {!isAndroid && (
            <a
              href="#"
              className="inline-flex items-center gap-2.5 bg-[var(--text-primary)] text-[var(--bg)] px-5 py-2.5 rounded-xl text-sm font-medium hover:opacity-90 transition-opacity"
            >
