    ...
    <section className="relative h-[100dvh] flex flex-col items-center justify-center px-6 pt-14">
      <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
        ...
        <motion.a
          ...
          href="/#download"
          className="mt-10 inline-flex items-center gap-2.5 bg-[var(--text-primary)] text-[var(--bg)] px-6 py-3 rounded-full text-sm font-medium hover:opacity-85 transition-opacity"
        >
      ...
      >
        <div className="w-px h-8 bg-gradient-to-b from-[var(--gold-active)]/40 to-transparent" />
      </motion.div>
    </section>
  );
}
