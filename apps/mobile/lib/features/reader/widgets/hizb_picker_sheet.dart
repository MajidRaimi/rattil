...
class HizbPickerSheet extends ConsumerWidget {
  final int currentHizb;
  final ValueChanged<int> onHizbSelected;

  const HizbPickerSheet({
    super.key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final rangesAsync = ref.watch(hizbPageRangesProvider);

    const itemHeight = 64.0;
    final initialOffset =
        ((currentHizb - 1) * itemHeight - itemHeight).clamp(0.0, double.infinity);
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                Text(
                  Locales.string(context, 'select_hizb'),
            ...
            child: rangesAsync.when(
              data: (ranges) => ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final hizb = r['hizb']!;
                  final isCurrent = hizb == currentHizb;
                  return InkWell(
                    onTap: () {
                      onHizbSelected(r['startPage']!);
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  '${Locales.string(context, 'hizb_label')} ${ordinal(hizb, locale)}',
